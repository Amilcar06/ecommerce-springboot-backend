    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Rutas de solo lectura accesibles sin autenticación (información pública del catálogo)
                        ...
                        // Rutas que requieren autenticación para cualquier operación
                        .requestMatchers("/api/carritos/**", "/api/pedidos/**", "/api/pagos/**", "/api/facturas/**")
                        .hasAnyAuthority("ROLE_ADMIN", "ROLE_VENDEDOR", "ROLE_USUARIO")
